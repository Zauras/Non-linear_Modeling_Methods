package Binomial_Heap_Test;
import java.util.Scanner;
 
  
 
 public class Binomial_Heap_Test
{
...
public static class BinomialHeapTest
{
    ...
    public static void main(String[] args)
    {
        ...
        /* Make object of BinomialHeapTest */
        BinomialHeapTest bh = new BinomialHeapTest( );
 
        char ch;
        /*  Perform BinomialHeapTest operations  */
        do    
        {
